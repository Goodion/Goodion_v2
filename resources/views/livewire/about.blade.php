    ...
    <div class="container xl:px-13 mx-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-main-black">
            ...
            <div class="flex justify-between mb-16">
                <div class="w-1/3 flex flex-col text-center object-center mr-8">
                    <img class="mx-auto w-16 mb-12" src="/img/icon/sale.png" alt="sale">
                ...
                <div class="w-1/3 flex flex-col flex-wrap text-center object-center mr-8">
                    <img class="mx-auto w-16 mb-12" src="/img/icon/time.png" alt="clock">
                ...
                <div class="w-1/3 flex flex-col text-center object-center">
                    <img class="mx-auto w-16 mb-12" src="/img/icon/user.png" alt="magnifying glass">
            ...
            <div class="flex flex-wrap flex-row content-between max-w-4xl mx-auto">
                <div class="flex flex-row mx-auto pb-6">
                    <div class="w-2/4 mr-3">
                        <img class="" src="/img/handcraft.png" alt="handcraft">
                    </div>
                    <div class="flex bg-main-green w-2/4 ml-3">
                        <p class="text-white py-15 px-12 self-center">
                ...
                <div class="flex flex-row mx-auto pb-6">
                    <div class="flex bg-main-orange w-2/4 mr-3">
                        <p class="text-white py-15 px-12 self-center mr-3">
                    ...
                    <div class="w-2/4 ml-3">
                        <img class="" src="/img/trends.png" alt="handcraft">
                    </div>
                </div>
                <div class="flex flex-row mx-auto">
                    <div class="w-2/4 mr-3">
                        <img class="" src="/img/sales.png" alt="handcraft">
                    </div>
                    <div class="flex bg-main-blue w-2/4 ml-3">
                        <p class="text-white py-15 px-12 self-center">
